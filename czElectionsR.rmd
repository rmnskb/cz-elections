...
$TN$ and $TP$ are on the main diagonal, $FN$ and $FP$ are on the counter diagonal.

Following metrics will be used for models assessing:
...
Although this algorithm still struggles with assigning the positive class correctly, sensitivity rate resembles this characteristic.
```{r randf metrics 1}
